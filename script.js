let quizData = [
  ...
  {
    question: "また、競争環境において、あるべき姿と現状とのギャップを埋めるための計画あるいは方策が（　　）であり",
    choices: ["経営理念","ビジョン","戦略","戦術"],
    correct: "戦略"
  },
  {
    question: "対外的目標設定のポイントとして、戦略を実行するための具体的なプランが（　　）である。",
    choices: ["経営理念","ビジョン","戦略","戦術"],
    correct: "戦術"
  },
  {
  ...
  {
    question: "これからの調達領域に求められるものは開発段階への関与を深めた取り組みであるが、コスト面において求められる役割として適切なものを選択しなさい",
...
function loadQuestion() {
  ...
  // choices を毎回シャッフル（元の順序を壊さないようコピーしてから）
...
function nextQuestion() {
  ...
  const resultEl = document.getElementById("result");
  resultEl.className = "result"; // リセット
  ...
  if (isCorrect) {
    ...
    resultEl.textContent = "❌ 不正解（正解：" + correctAnswers.join(" , ") + "）";
    resultEl.classList.add("ng");
    wrongQuestions.push(q);
  }

  // ★ ここで得点が変わるので、即ヘッダー更新（最終問題でも反映される）
  current++;
  updateHeader();
